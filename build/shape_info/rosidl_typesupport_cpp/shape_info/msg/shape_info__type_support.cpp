...
static const _ShapeInfo_type_support_symbol_names_t _ShapeInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, shape_info, msg, ShapeInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, shape_info, msg, ShapeInfo)),
  }
};
...
{
  return &::shape_info::msg::rosidl_typesupport_cpp::ShapeInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, shape_info, msg, ShapeInfo)() {
  return get_message_type_support_handle<shape_info::msg::ShapeInfo>();
}
