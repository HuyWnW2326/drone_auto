...
static const _ShapeInfo_type_support_symbol_names_t _ShapeInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, shape_info, msg, ShapeInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, shape_info, msg, ShapeInfo)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, shape_info, msg, ShapeInfo)() {
  return &::shape_info::msg::rosidl_typesupport_c::ShapeInfo_message_type_support_handle;
}
